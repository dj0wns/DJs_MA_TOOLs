...
class ImageCanvas:
  ...
  def get_visible_center_game_point(self):

    print(str(self.frame.winfo_height()/2), str(self.frame.winfo_width()/2))
    return  self.pixel_to_wld_coords(self.frame.winfo_width()/2, self.frame.winfo_height()/2)
