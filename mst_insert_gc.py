...
if __name__ == '__main__':
  ...
  original_location = int.from_bytes(mst_reader.read(4), "big")
  original_length = int.from_bytes(mst_reader.read(4), "big")
  original_timestamp = int.from_bytes(mst_reader.read(4), "big")
  original_crc = int.from_bytes(mst_reader.read(4), "big")
  ...
  file_count = int.from_bytes(mst_reader.read(4), "big")
  ...
  for i in range(file_count):
    ...
    location = int.from_bytes(mst_reader.read(4), "big")
    length = int.from_bytes(mst_reader.read(4), "big")
    timestamp = int.from_bytes(mst_reader.read(4), "big")
    crc = int.from_bytes(mst_reader.read(4), "big")
