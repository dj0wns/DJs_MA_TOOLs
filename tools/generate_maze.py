...
def execute(length, width, center_x, center_y, tesselation, mesh_name, mesh_width, path_thickness, routing, output):
...
if __name__ == '__main__':
  ...
  execute(args.length, args.width, args.center_x, args.center_y, args.tesselation, args.routing, args.mesh_name, args.mesh_width, args.path_thickness, args.output)
